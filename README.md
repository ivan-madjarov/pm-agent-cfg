...
- **Registry Export** - export DCAgent registry subtree for support (`--export` / `-Export`) producing `pm-agent-dca-YYYYMMDDHHMMSS.reg` in current directory (menu option 9 / 8)
